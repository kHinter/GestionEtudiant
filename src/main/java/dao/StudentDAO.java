...
public class StudentDAO {
    public List<Student> getAll() throws SQLException {
        ...
        while(queryResult.next())
        {
            ...
            student.setPromotion(groupDAO.getById(queryResult.getString("Id_promo")));
    ...
    public List<Student> getByGroupId(String groupId) throws SQLException {
        PreparedStatement statement = DatabaseConnection.getInstance().getConnection().prepareStatement("SELECT * FROM etudiant WHERE Id_groupe_TD = ? OR Id_groupe_TP = ? OR Id_promo = ?;");
    ...
    private boolean isIdExists(String id) throws SQLException {
        PreparedStatement statement = DatabaseConnection.getInstance().getConnection().prepareStatement("SELECT Num_etu FROM ETUDIANT WHERE Num_etu = ?;");
        statement.setString(1, id);
    ...
    public void save(Student student) throws SQLException
    {
        if(!isIdExists(student.getNum()))
        {
            ...
            statement.setString(14, student.getPromotion().getId());
        ...
        else
        {
            ...
            statement.setString(13, student.getPromotion().getId());
